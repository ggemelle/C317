...
const PagePesquisaAdminRespostas = ({ route }) => {
  ...
  const handlePesquisaSelecionada = (research_id, research_name) => {
    ...
    navigation.navigate('PageAdminRespostas', {employeeId, research_id, research_name });
  };
...
export default PagePesquisaAdminRespostas;
